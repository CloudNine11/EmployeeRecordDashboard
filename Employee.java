...
//                add(l1);
		...
		JLabel lblName = new JLabel("NEW EMPLOYEE DETAILS");
...
//                    Conn c = new Conn();
//                    ResultSet rs = c.s.executeQuery("select * from record where username = '"+username+"'");
//                    while(rs.next()){
...
//             Class.forName("com.mysql.cj.jdbc.Driver");
          Connection  c = DriverManager.getConnection("jdbc:mysql:///mysql", "root",
                    "itstudent");
        PreparedStatement ps=c.prepareStatement("Insert into record(s1,s2,s3,s4,s5,s7,s8,s10)values(?,?,?,?,?,?,?,?,?)");                                                                    
                                String q1 = "insert into record values('"+s9+"','"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s7+"','"+s8+"','"+s10+"')";
                                  ps.setString(1,s9);
                                    ps.setString(2,s1);
                                    ps.setString(3,s2);
                                    ps.setString(4,s3);
		...
		btnExit.setBounds(250, 430, 120, 30);
